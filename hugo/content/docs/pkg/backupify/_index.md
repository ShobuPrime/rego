...
- [type ActivityClient](<#ActivityClient>)
  - [func \(c \*ActivityClient\) GetActivities\(appType AppType\) \(\*Activities, error\)](<#ActivityClient.GetActivities>)
...
- [type ExportClient](<#ExportClient>)
  ...
  - [func \(c \*ExportClient\) ExportUsers\(users \*Users\) error](<#ExportClient.ExportUsers>)
...
- [type SnapshotClient](<#SnapshotClient>)
  - [func \(c \*SnapshotClient\) GetSnapshotDates\(appType AppType, user \*User\) \(\*Snapshots, error\)](<#SnapshotClient.GetSnapshotDates>)
- [type Snapshots](<#Snapshots>)
- [type SnapshotsPayload](<#SnapshotsPayload>)
- [type Stats](<#Stats>)
- [type User](<#User>)
- [type UserClient](<#UserClient>)
  - [func \(c \*UserClient\) GetAllUsers\(appType AppType\) \(\*Users, error\)](<#UserClient.GetAllUsers>)
